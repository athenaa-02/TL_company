...
function PracticeAreasPaper() {
  return (
    <div className="relative z-10 mx-auto w-[90%] max-w-[900px] -mt-53.25 lg:-mt-80 xl:-mt-60 2xl:-mt-80 box-border  max-w-232.75 flex flex-col items-center outline-1 outline-accent   -outline-offset-15 bg-white px-6 py-12 text-heading sm:-mt-67 sm:px-10 sm:py-16 lg:px-16">
      <div className="mx-auto max-w-3xl text-center flex flex-col items-center">
    <div className="w-px h-18 sm:h-25 bg-heading"></div>
      ...
      <div className="mt-10 w-full max-w-160 grid grid-cols-2 gap-x-1 gap-y-6 sm:gap-x-0 sm:gap-y-14">
        {practiceAreas.map((area) => (
          <article key={area.name} className="text-center">
            <div className="mx-auto flex aspect-square w-25 xs:w-34 md:w-full max-w-40  items-center justify-center overflow-hidden">
              <img
                src={area.image}
                alt=""
      ...
      <div className=" text-center mt-11 sm:mt-18">
        <button
          type="button"
